...
public class LinerRegression extends OLSMultipleLinearRegression {
    ...
    public LinerRegression(String yTitle, String[] xTitles, double[] y, double[][] x, Integer trainRecords) {
